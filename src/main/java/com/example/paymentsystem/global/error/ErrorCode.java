package com.example.paymentsystem.global.error;
...
public enum ErrorCode {
    ...
    CART_ITEM_STOCK_EXCEEDED(HttpStatus.CONFLICT,    "CART_004", "요청 수량이 재고를 초과합니다."),
    CART_NOT_FOUND(HttpStatus.NOT_FOUND,             "CART_005", "장바구니가 존재하지 않습니다."),
